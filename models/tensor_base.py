...
class MipTensorBase(TensorBase):
    def __init__(
        ...
        **kwargs
        ...
        self.train_freq_domain = train_freq_domain
        self.inverse_method = inverse_method
        self.force_mask = force_mask
        self.force_seperate = force_seperate
    ...
    def get_kwargs(self):
        ...
        kwargs.update({
            ...
            "train_freq_domain": self.train_freq_domain, 
            "inverse_method": self.inverse_method,
            "force_mask": self.force_mask,
            "force_seperate": self.force_seperate,
    ...
    def forward(self, ray_batch, n_samples, is_train, ndc_ray, radii=None):
        ...
        if self.scale_types is not None and (self.apply_mask):
